...
- [x] Task 1: Remove the background prefetch and cache system
...
- [x] Task 2: Add text input UI to the modal
...
- [x] Task 3: Wire Generate button to API call with updated prompt
...
- [x] Task 4: Clean up dead code and polish
